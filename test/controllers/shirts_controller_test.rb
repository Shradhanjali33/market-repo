...
class ShirtsControllerTest < ActionController::TestCase
  ...
  test "should create shirt" do
    assert_difference('Shirt.count') do
      post :create, shirt: { brand: @shirt.brand, categories: @shirt.categories, color: @shirt.color, price: @shirt.price, size: @shirt.size }
    end
  ...
  test "should update shirt" do
    patch :update, id: @shirt, shirt: { brand: @shirt.brand, categories: @shirt.categories, color: @shirt.color, price: @shirt.price, size: @shirt.size }
    assert_redirected_to shirt_path(assigns(:shirt))
  end
